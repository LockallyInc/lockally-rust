...
pub async fn signup(configuration: &configuration::Configuration, signup_request: models::SignupRequest) -> Result<models::V1AdminLoginPost200Response, Error<SignupError>> {
