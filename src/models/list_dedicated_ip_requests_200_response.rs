...
pub struct ListDedicatedIpRequests200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::DedicatedIpRequest>,
}

impl ListDedicatedIpRequests200Response {
    pub fn new(data: Vec<models::DedicatedIpRequest>) -> ListDedicatedIpRequests200Response {
