...
pub struct V1MessagesGet200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::Message>,
...
impl V1MessagesGet200Response {
    pub fn new(data: Vec<models::Message>) -> V1MessagesGet200Response {
