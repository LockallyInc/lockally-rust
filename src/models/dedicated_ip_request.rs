...
pub struct DedicatedIpRequest {
    ...
    #[serde(rename = "admin_note", skip_serializing_if = "Option::is_none")]
...
impl DedicatedIpRequest {
    pub fn new(id: uuid::Uuid, tenant_id: uuid::Uuid, status: Status, created_at: chrono::DateTime<chrono::FixedOffset>) -> DedicatedIpRequest {
        DedicatedIpRequest {
            id,
            tenant_id,
            status,
