...
pub struct V1MailboxesGet200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::Mailbox>,
    #[serde(rename = "limit")]
    pub limit: i32,
}

impl V1MailboxesGet200Response {
    pub fn new(data: Vec<models::Mailbox>, limit: i32) -> V1MailboxesGet200Response {
