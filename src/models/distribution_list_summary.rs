...
pub struct DistributionListSummary {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
...
impl DistributionListSummary {
    pub fn new(id: uuid::Uuid, tenant_id: uuid::Uuid, list_address: String, created_at: chrono::DateTime<chrono::FixedOffset>, member_count: i32) -> DistributionListSummary {
