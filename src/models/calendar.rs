...
pub struct Calendar {
    ...
    #[serde(rename = "feed_url", skip_serializing_if = "Option::is_none")]
...
impl Calendar {
    pub fn new(id: uuid::Uuid, tenant_id: uuid::Uuid, name: String, visibility: Visibility, created_at: chrono::DateTime<chrono::FixedOffset>, updated_at: chrono::DateTime<chrono::FixedOffset>) -> Calendar {
        Calendar {
            id,
            tenant_id,
            name,
