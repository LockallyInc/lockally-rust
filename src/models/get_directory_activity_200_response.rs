...
pub struct GetDirectoryActivity200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetDirectoryActivity200ResponseDataInner>>,
}

impl GetDirectoryActivity200Response {
    pub fn new() -> GetDirectoryActivity200Response {
