...
pub struct ListMigrations200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::Migration>,
}

impl ListMigrations200Response {
    pub fn new(data: Vec<models::Migration>) -> ListMigrations200Response {
