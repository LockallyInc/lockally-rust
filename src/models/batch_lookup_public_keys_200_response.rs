...
pub struct BatchLookupPublicKeys200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::BatchLookupPublicKeys200ResponseDataInner>>,
}

impl BatchLookupPublicKeys200Response {
    pub fn new() -> BatchLookupPublicKeys200Response {
