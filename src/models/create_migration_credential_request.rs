...
pub struct CreateMigrationCredentialRequest {
    #[serde(rename = "provider")]
    pub provider: Provider,
    #[serde(rename = "label", skip_serializing_if = "Option::is_none")]
    pub label: Option<String>,
    #[serde(rename = "credentials")]
    pub credentials: Box<models::CreateMigrationCredentialRequestCredentials>,
}

impl CreateMigrationCredentialRequest {
    pub fn new(provider: Provider, credentials: models::CreateMigrationCredentialRequestCredentials) -> CreateMigrationCredentialRequest {
