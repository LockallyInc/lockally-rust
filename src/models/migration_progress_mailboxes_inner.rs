...
pub struct MigrationProgressMailboxesInner {
...
impl MigrationProgressMailboxesInner {
    pub fn new(source_email: String, status: String, synced_message_count: i32, failed_message_count: i32, percent_complete: f64) -> MigrationProgressMailboxesInner {
