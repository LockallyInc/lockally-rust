...
pub struct ActivateAddOn200Response {
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    #[serde(rename = "add_on")]
    pub add_on: String,
...
impl ActivateAddOn200Response {
    pub fn new(id: uuid::Uuid, add_on: String, status: String, message: String) -> ActivateAddOn200Response {
