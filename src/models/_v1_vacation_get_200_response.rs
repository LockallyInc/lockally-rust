...
pub struct V1VacationGet200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::VacationResponder>,
}

impl V1VacationGet200Response {
    pub fn new(data: Vec<models::VacationResponder>) -> V1VacationGet200Response {
