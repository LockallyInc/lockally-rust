...
pub struct ListCalendarIntegrations200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::CalendarIntegration>>,
}

impl ListCalendarIntegrations200Response {
    pub fn new() -> ListCalendarIntegrations200Response {
