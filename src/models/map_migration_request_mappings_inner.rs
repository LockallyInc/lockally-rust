...
pub struct MapMigrationRequestMappingsInner {
    #[serde(rename = "source_email")]
    pub source_email: String,
    #[serde(rename = "dest_email")]
    pub dest_email: String,
}

impl MapMigrationRequestMappingsInner {
    pub fn new(source_email: String, dest_email: String) -> MapMigrationRequestMappingsInner {
