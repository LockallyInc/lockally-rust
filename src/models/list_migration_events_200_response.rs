...
pub struct ListMigrationEvents200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::MigrationEvent>,
}

impl ListMigrationEvents200Response {
    pub fn new(data: Vec<models::MigrationEvent>) -> ListMigrationEvents200Response {
