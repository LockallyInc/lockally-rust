...
pub struct MessageStatsRates {
    ...
    pub bounced: Option<f32>,
    #[serde(rename = "deferred", skip_serializing_if = "Option::is_none")]
    pub deferred: Option<f32>,
    #[serde(rename = "complaint", skip_serializing_if = "Option::is_none")]
    pub complaint: Option<f32>,
}

impl MessageStatsRates {
    pub fn new() -> MessageStatsRates {
        MessageStatsRates {
            delivered: None,
            bounced: None,
            deferred: None,
