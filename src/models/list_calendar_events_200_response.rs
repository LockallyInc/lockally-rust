...
pub struct ListCalendarEvents200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::CalendarEvent>>,
}

impl ListCalendarEvents200Response {
    pub fn new() -> ListCalendarEvents200Response {
