...
pub struct ListMigrationMailboxes200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::MigrationMailbox>,
}

impl ListMigrationMailboxes200Response {
    pub fn new(data: Vec<models::MigrationMailbox>) -> ListMigrationMailboxes200Response {
