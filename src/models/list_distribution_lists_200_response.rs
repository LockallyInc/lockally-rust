...
pub struct ListDistributionLists200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::DistributionListSummary>,
}

impl ListDistributionLists200Response {
    pub fn new(data: Vec<models::DistributionListSummary>) -> ListDistributionLists200Response {
