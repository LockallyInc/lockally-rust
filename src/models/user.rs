...
pub struct User {
    ...
    #[serde(rename = "mailbox_count", skip_serializing_if = "Option::is_none")]
    pub mailbox_count: Option<i32>,
}

impl User {
    pub fn new(id: uuid::Uuid, tenant_id: uuid::Uuid, email: String, first_name: String, last_name: String, status: Status, created_at: chrono::DateTime<chrono::FixedOffset>, updated_at: chrono::DateTime<chrono::FixedOffset>) -> User {
        User {
            id,
            tenant_id,
            email,
