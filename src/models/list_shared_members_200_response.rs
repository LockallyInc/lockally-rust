...
pub struct ListSharedMembers200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::SharedMember>,
}

impl ListSharedMembers200Response {
    pub fn new(data: Vec<models::SharedMember>) -> ListSharedMembers200Response {
