...
pub struct GetContactList200Response {
    #[serde(rename = "list", skip_serializing_if = "Option::is_none")]
    pub list: Option<Box<models::ContactList>>,
    #[serde(rename = "members", skip_serializing_if = "Option::is_none")]
    pub members: Option<Vec<models::GetContactList200ResponseMembersInner>>,
}

impl GetContactList200Response {
    pub fn new() -> GetContactList200Response {
