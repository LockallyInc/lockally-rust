...
pub struct GetStorage200ResponseTopMailboxesInner {
    #[serde(rename = "email", skip_serializing_if = "Option::is_none")]
    pub email: Option<String>,
    #[serde(rename = "usage_bytes", skip_serializing_if = "Option::is_none")]
    pub usage_bytes: Option<i64>,
}

impl GetStorage200ResponseTopMailboxesInner {
    pub fn new() -> GetStorage200ResponseTopMailboxesInner {
