...
pub struct GetDomainsStatus200Response {
    #[serde(rename = "domains", skip_serializing_if = "Option::is_none")]
    pub domains: Option<Vec<models::GetDomainsStatus200ResponseDomainsInner>>,
    #[serde(rename = "generated_at", skip_serializing_if = "Option::is_none")]
    pub generated_at: Option<chrono::DateTime<chrono::FixedOffset>>,
}

impl GetDomainsStatus200Response {
    pub fn new() -> GetDomainsStatus200Response {
