...
pub struct ListMigrationCredentials200Response {
    #[serde(rename = "data")]
    pub data: Vec<models::MigrationCredential>,
}

impl ListMigrationCredentials200Response {
    pub fn new(data: Vec<models::MigrationCredential>) -> ListMigrationCredentials200Response {
