...
pub struct GetDomainsStatus200ResponseDomainsInner {
    #[serde(rename = "domain", skip_serializing_if = "Option::is_none")]
    pub domain: Option<String>,
    #[serde(rename = "verified", skip_serializing_if = "Option::is_none")]
    pub verified: Option<bool>,
    #[serde(rename = "checks", skip_serializing_if = "Option::is_none")]
    pub checks: Option<Vec<models::GetDomainsStatus200ResponseDomainsInnerChecksInner>>,
}

impl GetDomainsStatus200ResponseDomainsInner {
    pub fn new() -> GetDomainsStatus200ResponseDomainsInner {
