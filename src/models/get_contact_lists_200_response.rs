...
pub struct GetContactLists200Response {
    #[serde(rename = "data", skip_serializing_if = "Option::is_none")]
    pub data: Option<Vec<models::GetContactLists200ResponseDataInner>>,
}

impl GetContactLists200Response {
    pub fn new() -> GetContactLists200Response {
