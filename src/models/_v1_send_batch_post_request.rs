...
pub struct V1SendBatchPostRequest {
    #[serde(rename = "messages")]
    pub messages: Vec<models::SendMessage>,
}

impl V1SendBatchPostRequest {
    pub fn new(messages: Vec<models::SendMessage>) -> V1SendBatchPostRequest {
