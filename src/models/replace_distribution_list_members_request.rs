...
pub struct ReplaceDistributionListMembersRequest {
    #[serde(rename = "members")]
    pub members: Vec<String>,
}

impl ReplaceDistributionListMembersRequest {
    pub fn new(members: Vec<String>) -> ReplaceDistributionListMembersRequest {
